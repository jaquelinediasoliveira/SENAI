...
public class ReservasProcess {
	...
	public JSONArray read(String nomePessoa, String nomeLivro) throws JSONException {
	...
	public boolean update(Reservas reserva) {
		String query = "UPDATE reservas SET nome_pessoa = ?, nome_livro = ?, data_devolucao = ? WHERE id = ?";
